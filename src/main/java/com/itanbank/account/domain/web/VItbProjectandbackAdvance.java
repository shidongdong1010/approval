 ...
 */
@Entity
@Table(name = "v_itb_projectandback_advance")
public class VItbProjectandbackAdvance implements Serializable {
    ...
    @Column(name = "backloanuserid", length = 11)
    public Long getBackloanuserid() {
        return backloanuserid;
    }

    public void setBackloanuserid(Long backloanuserid) {
        this.backloanuserid = backloanuserid;
    }
    ...
    @Column(name = "backstatus", length = 1)
