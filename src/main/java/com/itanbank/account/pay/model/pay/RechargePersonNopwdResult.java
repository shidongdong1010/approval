 ...
 *
 */
public class RechargePersonNopwdResult {
	...
	public String toString() {
		return "RechargePersonNopwdResult [trade_no=" + trade_no + ", com_amt_type=" + com_amt_type + ", mer_date="
				+ mer_date + ", sign_type=" + sign_type + ", ret_msg=" + ret_msg + ", order_id=" + order_id
				+ ", com_amt=" + com_amt + ", version=" + version + ", sign=" + sign + ", balance=" + balance
				+ ", ret_code=" + ret_code + ", mer_id=" + mer_id + ", mer_check_date=" + mer_check_date + "]";
	}
