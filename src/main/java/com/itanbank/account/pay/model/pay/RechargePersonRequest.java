 ...
 *
 */
public class RechargePersonRequest {

	/** 接口名称*/
	private String service = "mer_recharge_person";
	/** 签名方式*/
	...
	/** 页面跳转同步通知页面路径*/
	private String ret_url = BasicModel.NOTIFY_SERVER+"pay/recharge/person/return.html";
	/** 服务器异步通知页面路径*/
	private String notify_url = BasicModel.NOTIFY_SERVER+"pay/recharge/person/notify.html";
	/** 试图类型*/
	...
	public String toString() {
		return "RechargePerson [service=" + service + ", sign_type=" + sign_type + ", charset=" + charset
				...
				+ mer_date + ", pay_type=" + pay_type + ", user_id=" + user_id + ", account_id=" + account_id
				+ ", amount=" + amount + ", gate_id=" + gate_id + ", user_ip=" + user_ip + ", com_amt_type="
				+ com_amt_type + "]";
	}
