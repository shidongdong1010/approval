 ...
 *
 */
public class TransferAsynRequest {

	/** 接口名称*/
	private String service = "transfer_asyn";
	/** 签名方式*/
	...
	/** 页面跳转同步通知页面路径*/
	private String ret_url = BasicModel.NOTIFY_SERVER+"pay/transfer/asyn/return.html";
	/** 服务器异步通知页面路径*/
	private String notify_url = BasicModel.NOTIFY_SERVER+"pay/transfer/asyn/notify.html";
	/** 试图类型*/
	...
	public String toString() {
		return "TransferAsyn [service=" + service + ", sign_type=" + sign_type + ", charset=" + charset
				...
				+ mer_date + ", mer_account_id=" + mer_account_id + ", partic_acc_type=" + partic_acc_type
