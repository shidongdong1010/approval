 ...
 *
 */
public class ProjectTransferSynchro {
	...
	/** 服务器异步通知页面路径*/
	private String notify_url = BasicModel.NOTIFY_SERVER+"project/transferSynchroNotify.html";
	/** 视图类型*/
	...
	public String toString() {
		return "ProjectTransferSynchro [service=" + service + ", sign_type=" + sign_type + ", charset=" + charset
