...
public class UserBindAgreementRequest {
	...
	/** 接口名称*/
	private String service = "ptp_mer_bind_agreement";
	/** 签名方式*/
	...
	/** 页面跳转同步通知页面路径*/
	private String ret_url = BasicModel.NOTIFY_SERVER+"user/bindAgreementReturn.html"; 
	/** 服务器异步通知页面路径*/
	private String notify_url = BasicModel.NOTIFY_SERVER+"user/bindAgreementNotify.html"; 
	...
	public String toString() {
		return "UserBindAgreement [service=" + service + ", sign_type=" + sign_type + ", charset=" + charset
				...
				+ account_id + ", user_bind_agreement_list=" + user_bind_agreement_list + "]";
	} 
}
