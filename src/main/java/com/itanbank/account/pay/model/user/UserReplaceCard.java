 ...
 *
 */
public class UserReplaceCard {

	/** 接口名称*/
	private String service = "ptp_mer_replace_card";
	/** 签名方式*/
	...
	/** 页面跳转同步通知页面路径*/
	private String ret_url = BasicModel.NOTIFY_SERVER+"user/replaceCardReturn.html";
	/** 服务器异步通知页面路径*/
	private String notify_url = BasicModel.NOTIFY_SERVER+"user/replaceCardNotify.html";
	...
	public String toString() {
		return "UserReplaceCard [service=" + service + ", sign_type=" + sign_type + ", charset=" + charset
				...
				+ ", account_area=" + account_area + ", card_branch_name=" + card_branch_name + "]";
	}
