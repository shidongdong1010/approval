 ...
 *
 */
public class UserUnbindAgreementResult {
	...
	public String toString() {
		return "UserUnbindAgreementResult [mer_id=" + mer_id + ", ret_code=" + ret_code + ", ret_msg=" + ret_msg
				+ ", service=" + service + ", sign_type=" + sign_type + ", user_unbind_agreement_list="
				+ user_unbind_agreement_list + ", user_id=" + user_id + ", version=" + version + ", sign=" + sign + "]";
	}
}
