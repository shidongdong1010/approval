	...
	<script type="text/javascript">
		function gridReload() {
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
				url : "${ctx}/transfer/advanceRecordInfoList.json",
				mtype : "post",
				page : 1,
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				mtype : "post",
				height: 330,
				colNames:['id','垫付记录ID','垫付本金', '垫付利息','垫付第三方支付帐号','还款记录ID','借款人id','标的ID','垫付时间','垫付公司ID','垫付状态','创建时间'],
				colModel:[
					{
						name:'id',
						index:'id',
