	...
	<script type="text/javascript">
		function gridReload() {
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
				url : "${ctx}/transfer/backToAdvanceList.json",
				mtype : "post",
				page : 1,
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				mtype : "post",
				height: 330,
				colNames:['id','借款用户ID','投资记录ID', '标的ID','期数','还款日期','还款ID','垫付方ID','还款本金','还款利息','违约金','状态','创建时间'],
				colModel:[
					{
						name:'id',
						index:'id',
