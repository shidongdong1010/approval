	...
	<script type="text/javascript">
		function gridReload() {
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
				url : "${ctx}/transfer/backToPlatformList.json",
				mtype : "post",
				page : 1,
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				mtype : "post",
				height: 330,
				colNames:['id','标的ID','期数','借款人用户ID','还款ID','还款日期','平台公司ID','应还延迟还款服务费','已还延迟还款服务费','状态','创建时间'],
				colModel:[
					{
						name:'id',
						index:'id',
					...
					{
						name:'paidLateRepayServerAmount',
