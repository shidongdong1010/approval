	...
	<script type="text/javascript">
		function gridReload() {
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
				url : "${ctx}/transfer/backToUserList.json",
				mtype : "post",
				page : 1,
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				mtype : "post",
				height: 330,
				colNames:['id','借款用户ID','投资记录ID', '标的ID','期数','还款日期','还款ID','投资用户ID','用户类型','还款本金','收益金额','状态','创建时间'],
				colModel:[
					{
						name:'id',
						index:'id',
