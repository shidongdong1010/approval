	...
	<script type="text/javascript">
		function gridReload() {
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
				url : "${ctx}/transfer/investInfoList.json",
				mtype : "post",
				page : 1,
				postData: {projectId:projectId,userName:userName}
			}).trigger("reloadGrid");
		}
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				colNames:['投资id','用户ID','投资人姓名', '投资人电话','合同编号','标的ID','投资金额','收益率','预期收益','投资时间','状态','投资类型'],
				colModel:[
					{
						name:'id',
						index:'id',
