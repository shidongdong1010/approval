			...
			<div class="main-content">
				...
				<div class="page-content">
					<table style="padding-bottom: 20px">
						<tr >
							<td> 手机号:</td>
							<td><input type="text" id="mobile" name="mobile" width="200px"/></td>
							<td>
					...
					<div id="dialog-query-userInfo" class="hide">
					</div>
	...
	function queryUserInfo(id){
		...
		function gridReload() {
			...
			jQuery("#grid-table").jqGrid('setGridParam', {
				url : "${ctx}/transfer/userInfoList.json",
				mtype : "post",
				page : 1,
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				mtype : "post",
				height: 330,
				colNames:['用户id','手机号码','用户姓名','身份证号','银行类型','银行卡号','注册来源','最后登录时间','创建时间','操作'],
				colModel:[
					{
						name:'id',
						index:'id',
					...
					},
					{
						...
						editable: false,
						formatter: function(value, options, rowObject){
							return "<a href=\"javascript: queryUserInfo("+rowObject['id']+")\">客户详细信息</a>";
						}
					}
				],
